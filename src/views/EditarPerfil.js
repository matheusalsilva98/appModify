            ...
            <View style={{
                ...
                <View style={{flex: 1, alignItems: 'center', flexDirection: 'row'}}>
                    ...
                    <TouchableOpacity onPress={() => {
                        props.navigation.navigate('Lista Batatas')
                    }}>
                        <Image source={require('../../assets/icone_voltar_lista.png')} style={{width:70, height:70}}></Image>
                    </TouchableOpacity>
                </View>
            </View>
            <Image
            ...
            <View style={{
                ...
                <ScrollView>
                    ...
                    <View style={{width:'100%', alignItems:'center'}}>
                        <Image source={require('../../assets/icone_editar_foto.png')} style={{marginTop: 10}} />
                    </View>
                    <View style={{flex:6, marginTop: 30}}>
                        <View style={{width:
                        useWindowDimensions().width*0.82}}>
                            <TextInput 
                                value={esqueceuSenha}
                                placeholder='Nome'
                        ...
                        <View>
                            ...
                            >
                                <View style={[styles.button, {marginRight: 5}]}>
                                    <Text style={[styles.textoButton, {color: 'black'}]}>Salvar</Text>
                                </View>
                            </TouchableOpacity>
                        </View>
                    </View>
